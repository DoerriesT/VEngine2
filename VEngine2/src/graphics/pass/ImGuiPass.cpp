	...
	:m_device(device)
{
	...
	gal::DescriptorSetLayoutBinding usedBinding{ gal::DescriptorType::TEXTURE, 0, 0, 65536, gal::ShaderStageFlags::PIXEL_BIT };
	gal::DescriptorSetLayoutDeclaration layoutDecl{ bindlessSetLayout, 1, &usedBinding };
	gal::StaticSamplerDescription staticSamplerDesc = gal::Initializers::staticLinearRepeatSampler(0, 1, gal::ShaderStageFlags::PIXEL_BIT);
...
void ImGuiPass::record(gal::CommandList *cmdList, const Data &data)
{
	...
	// begin renderpass
	gal::ColorAttachmentDescription colorAttachDesc{ data.m_colorAttachment, data.m_clear ? gal::AttachmentLoadOp::CLEAR : gal::AttachmentLoadOp::LOAD, gal::AttachmentStoreOp::STORE, {} };
